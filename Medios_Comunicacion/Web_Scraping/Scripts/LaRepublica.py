...
driver = bs.ejecutar_driver(
    f'https://www.larepublica.co/{empresa_}')
...
if not (bs.existedb(urlPrinc, "database", empresa)):  # Si no existe (elimine el .csv)
...
for art in articulos:
    ...
    # Agregar la fuente para que corra la función .existedb
